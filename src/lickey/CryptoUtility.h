...
namespace lickey
{
	auto Encrypt(std::string data, size_t datalen, std::string key, std::string iv, std::string& dest,
	             size_t& destlen) -> bool;

	auto Decrypt(std::string data, size_t datalen, std::string key, std::string iv, std::string& dest,
	             size_t& destlen) -> bool;
